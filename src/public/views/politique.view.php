 ...
 <main id="politique">
     ...
     <section class="policy">
         <div class="container">
             ...
             <p>Le but de cette politique de confidentialité est d'informer les utilisateurs de notre site des données personnelles que nous recueillerons ainsi que les informations suivantes, le cas écheant:</p>
             <ul>
             ...
             <h3>Les données à caractère personnel doivent être :</h3>
             <ul>
             ...
             <p>Nous ne collectons, ne stockons ni n'utilisons aucune donnée utilisateur sur notre site. Dans le cas où nous avons besoin de recueillir vos données, nous veillerons à vous fournir un préavis de ce recueil de données.</p>
             ...
             <ul>
                 ...
                 <li>contact@ak_aromatherapie.fr</li>
                 <li>142Bis, rue de la rue, 93100 Montreuil</li>
             </ul>
             <p>Date d'entrée en vigueur: le</p>
         </div>
     </section>
